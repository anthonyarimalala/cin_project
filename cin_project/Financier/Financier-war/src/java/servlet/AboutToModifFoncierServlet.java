 ...
 * @author antho
 */
public class AboutToModifFoncierServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
                ...
                request.setAttribute("fonciers", fonciers);
                 try{
                    ...
                    out.println(personnes.get(0).getCin());
                }catch(Exception e){
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AboutToModifFoncierServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AboutToModifFoncierServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
