...
public class Program
{
    static void Main(string[] args){
        ...
        List<Personne> personnes = pers.SelectByCin("Joh");

        // foreach (Personne personne in personnes)
        // {
        //     Console.WriteLine($"CIN : {personne.Cin}, Nom : {personne.Nom}, Prénom : {personne.Prenom}, Date de Naissance : {personne.DateNaissance}");
        // }

        // Info inf = new Info();
        // List<Info> infos = inf.SelectInfoByCin("PERS0001");
        // foreach (Info info in infos)
        // {
        //     Console.WriteLine($"info : {info.Allergie}");
        // }
        ...
        {
            Console.WriteLine($"unite : {unite.Symbole}");
        }

        Cours cours= new Cours();
        Cours c = cours.SelectCours("EUR");
        Console.WriteLine($"cours: {c.ValeurAriary}");

        // Antecedantt ant = new Antecedantt();
        // List<Antecedantt> ants = ant.SelectAntecedantByCin("PERS0001");
        // foreach (Antecedantt antecedantt in ants)
        // {
        //     Console.WriteLine($"antecedant : {antecedantt.Antecedant}");
        // }

        // Console.WriteLine("Connection MySQL: '"+MySqlConnectionHelper.GetConnection()+"'");
    }
}
...
public class Info{
    ...
    public List<Info> SelectInfoByCin(string cin)
    {
        MySqlConnection connection = MySqlConnectionHelper.GetConnection();
...
public class Antecedantt{
    ...
    public List<Antecedantt> SelectAntecedantByCin(string cin)
    {
        MySqlConnection connection = MySqlConnectionHelper.GetConnection();
